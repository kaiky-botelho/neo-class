...
public class TurmaService implements CrudService<Turma, Long> {
    ...
    @Override public List<Turma> listarTodos() { return repo.findAll(); }
    @Override public Turma buscarPorId(Long id) { return repo.findById(id).orElseThrow(); }
    @Override public Turma salvar(Turma t) { return repo.save(t); }
